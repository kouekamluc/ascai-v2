...
urlpatterns = [
    ...
    path('finances/contributions/', views.ContributionListView.as_view(), name='contribution_list'),
    path('finances/contributions/create/', views.ContributionCreateView.as_view(), name='contribution_create'),
    path('finances/contributions/<int:pk>/edit/', views.ContributionUpdateView.as_view(), name='contribution_edit'),
    path('finances/contributions/<int:pk>/delete/', views.ContributionDeleteView.as_view(), name='contribution_delete'),
